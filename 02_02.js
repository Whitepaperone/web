...
console.log('1.-----------------------')
const name=users.forEach((user)=>console.log(user.name))
console.log('2.-----------------------')
const marriage = users.filter((user)=>user.isMarried===true)
console.log(marriage)
console.log('3.-----------------------')
const tom=users.find((user)=>user.name==='Tom')
console.log(tom)
console.log('4.-----------------------')
const newUsers=users.map((user)=>{return {...user, isAlive:true}})
